...
def create_interface():
    ...
    with gr.Blocks() as demo:
        ...
        output_table = gr.DataFrame(
            label="分析结果(随机展示 20个)",
            headers=["图像", "diff", "model1_prediction", "model2_prediction"],
        ...
        analyze_btn.click(
            fn=analyze_results,
            inputs=[model1_pred_path, model2_pred_path, val_dir, only_diff, scene, max_samples],
...
"""
{
  ...
  "total_length": {
    ...
    "0.5": 3.0,
    "0.75": 8.0,
    "0.9": 13.800000000000011,
    "0.95": 20.200000000000017,
    "0.99": 27.91999999999996
  },
  "word_cnt": {
    "0.25": 1.0,
    "0.5": 1.0,
  ...
  "h": {
    ...
    "0.5": 25.0,
    "0.75": 31.0,
    "0.9": 42.60000000000002,
    "0.95": 70.80000000000001,
    "0.99": 90.0
  },
  "w/h": {
    "0.25": 0.88,
    "0.5": 1.2692307692307692,
    "0.75": 3.0,
    "0.9": 5.498666666666669,
    "0.95": 7.181333333333335,
    "0.99": 16.73073593073589
  }
}
"""